...
CREATE TABLE `apacs_errorreports` (
  ...
  `users_id` int(11) NOT NULL,
  `reporting_users_id` int(11) NOT NULL,
...
CREATE TABLE `apacs_pages` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_pages.unit_id_to_units.id_idx` (`unit_id`),
  CONSTRAINT `FK_pages.unit_id_to_units.id` FOREIGN KEY (`unit_id`) REFERENCES `apacs_units` (`id`)
...
CREATE TABLE `apacs_posts` (
  ...
  CONSTRAINT `FK_posts.pages_id_to_pages.id` FOREIGN KEY (`pages_id`) REFERENCES `apacs_pages` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=208 DEFAULT CHARSET=utf8 COLLATE=utf8_danish_ci;
...
CREATE TABLE `apacs_tasks_pages` (
  ...
  CONSTRAINT `FK_tasks_pages.pages_id_to_pages.id` FOREIGN KEY (`pages_id`) REFERENCES `apacs_pages` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=131071 DEFAULT CHARSET=utf8 COLLATE=utf8_danish_ci;
...
CREATE TABLE `apacs_tasks_posts` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_tasks_posts.post_id_to_posts.id_idx` (`posts_id`),
  KEY `FK_tasks_posts.collection_id_idx` (`tasks_id`),
  CONSTRAINT `FK_tasks_posts.posts_id_to_posts.id` FOREIGN KEY (`posts_id`) REFERENCES `apacs_posts` (`id`),
  CONSTRAINT `FK_tasks_posts.task_id_to_task.id` FOREIGN KEY (`tasks_id`) REFERENCES `apacs_tasks` (`id`)
...
CREATE TABLE `apacs_users` (
  ...
  `profileImageUrl` varchar(45) COLLATE utf8_danish_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_danish_ci;
