...
$collectionsSettings = array(
	...
	array(
		...
		//How to link the data level objects to images
		'objects_query' => 'select kortteg_files.id, CONCAT(IF(kortteg_files.id < 90000,\'https://www.kbhkilder.dk/collections/kortteg/\',\'https://d1c2oopk76d2la.cloudfront.net/\'),fileName) as imageURL, year, height, width,
                        description,
                        av_beskrivelse,
                        av_stam_id,
